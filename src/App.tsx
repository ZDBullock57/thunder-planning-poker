...
const DEBUG_ROLE = import.meta.env.VITE_DEBUG_ROLE as 'host' | 'participant' | undefined
...
export const App = () => {
  ...
  const isParticipant = DEBUG_MODE && DEBUG_ROLE 
    ? DEBUG_ROLE === 'participant'
    : !!joinId
...
<div className="min-h-screen bg-slate-900 font-sans">
      {isParticipant ? <ParticipantView joinId={joinId || 'debug-session'} /> : <HostView />}
    </div>
    </PeerProvider>
  )
}